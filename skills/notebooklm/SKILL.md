---
name: notebooklm
description: "Google NotebookLM完全API。ノートブック作成・ソース追加・ポッドキャスト生成・全アーティファクト生成。「NotebookLM」「ポッドキャスト」「ノートブック作成」で発動。Full programmatic access including features not in web UI."
---
